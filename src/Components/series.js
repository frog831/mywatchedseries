...
class Serie extends Component {
    ...
    getEpisodes = (serieID) => {
        if(!this.tvhub.isLoggedInTVHUB())
            throw Error("Trying to fetch episodes without being logged in to theTVHub, abort operation");
        this.setState({ loading: true });
        return this.tvhub.getEpisodesList(serieID).then(this.parseEpisodeList);
    }
